...
( function( factory ) {
  ...
  var cssTransitionSupport = function() {
    ...
    hasCssTransitionSupport = false !== cssTransitionSupport(),
    ...
    wasTouched = function( event ) {
      ...
      if ( ! hasPointers || 'undefined' === typeof event || 'undefined' === typeof event.pointerType ) {
        return false;
      }

      if ( 'undefined' !== typeof event.MSPOINTER_TYPE_MOUSE ) {
    ...
    hasFullscreenSupport = false !== fullscreenSupport(),
  ...
  $.fn.imageLightbox = function( opts ) {
    var targetSet = '',
      ...
      captionReset = function() {
        ...
        } else if ( 0 < $( target ).find( 'img' ).length ) {
        ...
        setTimeout( function() {
          ...
          if ( videoOptions ) {
            videos.each( function() {
              if ( this.i === target.data( 'ilb2VideoId' ) ) {
                ...
                element = this.e;
                if ( this.a ) {
                  if ( false === preloadedVideo ) {
                    element.attr( 'autoplay', this.a );
                  }
                  if ( true === preloadedVideo ) {
                    element.get( 0 ).play();
                  }
                }
              }
          ...
          image = element
            ...
            .on( 'touchmove.ilb7 pointermove.ilb7 MSPointerMove.ilb7', function( e ) {
              if ( ( ! hasPointers && 'pointermove' === e.type ) || ! wasTouched( e.originalEvent ) || options.quitOnImgClick ) {
                return true;
              }
              e.preventDefault();
    ...
    $( document ).ready( function() {
      ...
      if ( options.fullscreen && hasFullscreenSupport ) {
        $( document ).on( 'keydown.ilb7', function( e ) {
          ...
          if ( -1 < [ 9, 32, 38, 40 ].indexOf( e.which ) ) {
            e.stopPropagation();
            e.preventDefault();
          }
          if ( -1 < [ 13 ].indexOf( e.which ) ) {
            e.stopPropagation();
            e.preventDefault();
            toggleFullScreen();
          }
      ...
      if ( options.enableKeyboard ) {
        $( document ).on( 'keydown.ilb7', function( e ) {
          ...
          if ( -1 < [ 27 ].indexOf( e.which ) && options.quitOnEscKey ) {
            e.stopPropagation();
            e.preventDefault();
            _quitImageLightbox();
          }
          if ( -1 < [ 37 ].indexOf( e.which ) ) {
            e.stopPropagation();
            e.preventDefault();
            _previousTarget();
          }
          if ( -1 < [ 39 ].indexOf( e.which ) ) {
            e.stopPropagation();
            e.preventDefault();
            _nextTarget();
          }
